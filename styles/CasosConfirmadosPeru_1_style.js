...
var style_CasosConfirmadosPeru_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("31-may");
    var labelText = "";
    size = 0;
    ...
    if (value >= 189.000000 && value <= 1000.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 7000.000000 && value <= 10000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10000.000000 && value <= 103020.000000) {
            style = [ new ol.style.Style({
